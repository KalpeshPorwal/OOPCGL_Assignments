...
Name : Shalaka Alkute
Roll No : 21203
Problem Statement : Sunrise and Sunset using OpenGL
...
void drawAv(void) {
        ...
        glVertex3f(-0.9,-0.7,-1.0);//mountain 1
        ...
        glVertex3f(0.5,0.0,-1.0);//mountain 2
        ...
        glVertex3f(0.7,0.1,-2.0);//mountain 3
        ...
        glVertex3f(-0.7,-0.1,-2.0);//mountain 4
